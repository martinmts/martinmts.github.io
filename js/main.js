...
let navHTML = `<nav class="navbar navbar-expand-sm bg-light navbar-light fixed-top">
  <ul class="navbar-nav">
    ...
    <li class="nav-item dropdown"><a class="nav-link py-0 dropdown-toggle" href="https://github.com/martinmts/tree/main/Garrett_BiblicalHebrew/Downloads" data-toggle="dropdown">Resources</a>
      <div class="dropdown-menu">
